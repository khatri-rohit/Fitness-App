...
const CalModel = ({ setShowModel, saveEvent, eventTitle, setEventTitle, setSelectEvent, selectEvent, deleteEvent }) => {
    return (
        <>
            <div className="overlay-container absolute inset-0 flex flex-col items-center mx-auto p-3 bg-gray-400">
                <div className="relative p-4 w-full max-w-md max-h-full">
                    {/* <!-- Modal content --> */}
                    <div className="popup-box bg-white rounded-lg shadow dark:bg-gray-700">
                        {/* <!-- Modal header --> */}
                            ...
                            <form className="space-y-4" action="#">
                                <div>
                                    ...
                                    <input value={eventTitle}
                                        ...
                                        type="text" name="title" id="eventTitle" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required />
                                </div>
                                {selectEvent &&
